...
public class Runnable_000 extends Thread implements SystemRunner
{
	...
	public Runnable_000(org.system.rmi.SocketDatagram datagram)
	{
		...
		for (; is_running; )
		{
			try
			{
				...
				else
				{
					...
					this.datagram.server.interpreter.thread.interpret(1, datagram).struct.add(new org.system.rmi.SocketDatagram(1, datagram.socket));
				}
